      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-amber-400 mb-4">{restaurantData.name}</h3>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-gray-300">{restaurantData.address}</p>
              <p className="text-gray-300">{restaurantData.phone}</p>
              {restaurantData.email && (
                <p className="text-gray-300">{restaurantData.email}</p>
              )}
              {restaurantData.website && (
                <p className="text-gray-300">{restaurantData.website}</p>
              )}
            </div>
          </div>
        </div>
